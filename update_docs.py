...
FILES['docs/README.md'] = r"""<div align="center">
...
FILES['docs/ENDPOINTS.md'] = r"""## TxLINE Endpoints Used
...
FILES['docs/FEEDBACK.md'] = r"""## TxLINE API Feedback
...
FILES['docs/ARCHITECTURE.md'] = r"""## Architecture
...
def main():
    ...
    for path, content in FILES.items():
        ...
        print("wrote", path)
    print("Done.")
    print("Run: git rm apply_score.py backend/apply_score.py && git add README.md docs/ && git commit -m \'fix: remove dev files, fix outdated doc refs\' && git push")
